...
Future<MainProductModel> getPosts2() async {
  var apiUrl = Uri.parse('https://script.googleusercontent.com/macros/echo?user_content_key=8Dq27ZKx2uo3sHyrJl9u1l--dpguE9nMQAyekQvFJ9OhtGjuTr1U5S-wZitOCDPIW63Vz_5IaZAFGjByOCZw_o6K1Bb4HxxtOJmA1Yb3SEsKFZqtv3DaNYcMrmhZHmUMWojr9NvTBuBLhyHCd5hHa1GhPSVukpSQTydEwAEXFXgt_wltjJcH3XHUaaPC1fv5o9XyvOto09QuWI89K6KjOu0SP2F-BdwUh7dajWPvZd-bmx2H_66tfTwtNP8DvCKitafJxwa464MRkfpDutQTocCJ59mz8_6tvl7IGsXAM8lUdx0plUaXVQ&lib=MnrE7b2I2PjfH799VodkCPiQjIVyBAxva');

  final response = await http.get(apiUrl,headers: {"Accept": "application/json"});


  final dynamic jsonResponse = json.decode(response.body);
  final MainProductModel responseModel = MainProductModel.fromJson(jsonResponse);

  print("======${responseModel.products[0].subText}----${responseModel.products[0].title}");
